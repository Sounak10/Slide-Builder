  ...
  return (
    <div className={cn('mb-3 flex grow items-end gap-2 rounded-md pl-1 text-sm', className)}>
      <textarea
        ...
        className="field-sizing-content max-h-16 min-h-8 flex-1 resize-none py-2 scrollbar-thin focus:outline-none disabled:cursor-not-allowed disabled:opacity-50"
      />
      <Button
        size="icon"
        type="button"
        ...
        <div className="flex grow gap-1">
          ...
          {visibleControls.microphone && (
            <AgentTrackControl
              ...
              toggleButtonProps={microphoneToggle.buttonProps}
          ...
          {visibleControls.camera && (
            <AgentTrackControl
              ...
              toggleButtonProps={cameraToggle.buttonProps}
